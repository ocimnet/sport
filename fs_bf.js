            ...
            $.get(d.q + d.u, R(s, d.n), function(v) {
                ...
                for (i = 0; i < o; i++) {
                    ...
                    if (d.t) {
                        ...
                        h += "<tr valign='top'><td class='img_ajax'><img src='" + y + "' width='" + (d.w ? d.l.w : d.f.w) + "' height='" + (d.w ? d.l.h : d.f.h) + "' border='0'" + _H + "></td><td" + _Q + "11px'><a " + ((l == u.f) ? "class='sirri' " : "") + "href='" + u.f + "'" + (d.w ? "" : _A + "<span style=font-size:12px><b><u>" + a + "</u></b></span><br><br><img src=" + y + _K + ">" + J(z) + _F + ",250)'") + "><b>" + a + "</b></a> " + (d.w ? "<div class='fdesc'>" + J(z) + " <a class='readmore' href='" + u.f + "'>baca selengkapnya &#8594;</a></div>" : "") + "<span" + _Q + "9px'>Dipublikasikan pada <span" + _N + ">" + x.d + " " + x.m + " " + x.y + "</span>, berikan komentar <a" + _N + " class='garis' href='" + u.f + "#comments'" + (d.w ? "" : _A + "Berikan komentar ke: <b>" + a + "</b>\",250)'") + "><font" + _N + ">komentar</font></a> " + ((l == u.f) ? "<span style='color:#666'>(posting yang terbuka saat ini)</span>" : "") + "</span></td></tr>"
                    }
                }
                if (d.t) {
