    var _$_00 = " onmouseout='fs.tt.hide()' onmouseover='fs.tt.show(\"",
        _$_01 = "<a onclick='fs.ajaxBrowseMe(\"";
    $.support.cors = !0;
    (function($) {
            ...
            links: function(j) {
                return this.each(function() {
                    ...
                    if (j) {
                        ...
                        $(this)[0].href = fs.clickCond() ? fs.$_adf_ly(e) : fs.feng(h ? h : "f", e, f ? f : "Open Document", document.title);
                        fs.clickCount++
                    }
                })
            },
    ...
    (function(A, B, C, D, E, F, X, G, H, I, J, M, O, P, S) {
        ...
        _A = _$_00,
            _Z = "/feeds/posts/default",
            _B = "<br style='margin-bottom:",
            _C = "px'/>Loading data ke ",
            _D = "<table border='0' cellpadding='0' cellspacing='0'",
            _E = "openSearch$totalResults",
            _F = "<div class=clear style=height:2px/>\"",
            _G = " href='javascript:;'",
            _H = " class='fsnott'",
            _I = " onclick='$(\"",
            _J = "</td></tr></table>",
            _K = " width=100 class=tt_float_left align=left",
            _L = "$(this).val()",
            _M = "<td align='center'",
            _N = " style='color:#000'",
            _O = "><tr><td class='cntribboncolor' valign='middle' style='padding",
            _P = "><span class='spn'>",
            _Q = " style='font-size:",
            _R = "<option value=''",
            _S = {
    ...
    fs.warungbebas = function(A, B) {
        ...
        if (fs.is.single || fs.is.page) {
            ...
            (function(a, b, c, d, e, f) {
                $("a[target='_" + f + "']" + a + c + b + c + a + d + b + d + a + e + b + e).addClass(f).removeClass("zoom")
        ...
        (function(h) {
            var x = "supercounters",
                u = "http://www." + x + ".com/fc.php?id=" + h + "&w=1&v=1",
                d = document,
                w = window,
                y = screen,
                z;
